...
let first_dropdown = document.getElementById("first_dropdown");
let second_dropdown = document.getElementById("second_dropdown");
let first_recent = document.getElementById("first_recent");
let first_top = document.getElementById("first_top");
let second_recent = document.getElementById("second_recent");
let second_top = document.getElementById("second_top");
let first_fiat = document.getElementById("first_fiat");
let second_fiat = document.getElementById("second_fiat");
